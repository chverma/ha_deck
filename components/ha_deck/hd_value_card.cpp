...
void HdValueCard::render_() {
    ...
    lv_obj_set_style_text_font(lv_value_, font_normal, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    if (!unit_.empty())
    {
        ...
        lv_obj_set_style_text_font(unit_lbl, font_normal, LV_PART_MAIN | LV_STATE_DEFAULT);
    }
    ...
    if (!icon_.empty()) {
        ...
        lv_obj_set_style_text_font(icon_lbl, font_normal, LV_PART_MAIN | LV_STATE_DEFAULT);
    }
    if (!text_.empty())
    {
        ...
        lv_obj_set_style_text_font(text_lbl, font_normal, LV_PART_MAIN | LV_STATE_DEFAULT);
    }
